      ...
      {!pdfData ? (
        ...
        <div className="space-y-6">
          <div className="bg-pk-surface dark:bg-zinc-900 p-6 rounded-3xl border border-pk-border dark:border-white/5 flex items-center gap-6">
            <div className="w-16 h-20 bg-pk-surface-muted dark:bg-zinc-950 rounded-xl overflow-hidden shrink-0 border border-pk-border dark:border-zinc-800 flex items-center justify-center text-rose-500">{pdfData.thumbnail ? <img src={pdfData.thumbnail} className="w-full h-full object-cover" /> : <Palette size={20} />}</div>
          ...
          <div className="bg-pk-surface dark:bg-zinc-900 p-8 rounded-[2rem] border border-pk-border dark:border-white/5 space-y-8 shadow-sm">
            {!downloadUrl ? (
              <>
                <div className="text-center py-2 px-4 bg-pk-surface-muted dark:bg-zinc-950 rounded-2xl border border-pk-border dark:border-white/5">
