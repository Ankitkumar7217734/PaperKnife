      ...
      {!showMobileNav && (
        <header className="flex items-center justify-between px-4 md:px-8 h-16 md:h-20 border-b border-gray-100 dark:border-zinc-800 bg-white/80 dark:bg-zinc-950/80 backdrop-blur-md sticky top-0 z-[100]">
          ...
          <div className="flex items-center gap-1 md:gap-3 shrink-0">
            {isMobileBrowser && (
              <a 
                href="https://github.com/Ankitkumar7217734/PaperKnife/releases/latest" 
                target="_blank"
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-8 py-10 md:py-12">
            ...
            <div className="grid grid-cols-2 md:grid-cols-12 gap-8 mb-12">
              ...
              <div className="col-span-1 md:col-span-3">
                ...
                <ul className="space-y-2.5 text-xs text-gray-500 dark:text-zinc-500">
                  ...
                  <li><a href="https://github.com/Ankitkumar7217734/PaperKnife/blob/main/LICENSE" target="_blank" className="hover:text-rose-500 transition-colors">License</a></li>
                </ul>
              </div>
              ...
              <div className="col-span-1 md:col-span-3">
                ...
                <ul className="space-y-2.5 text-xs text-gray-500 dark:text-zinc-500">
                  <li><a href="https://github.com/Ankitkumar7217734/PaperKnife" target="_blank" className="flex items-center gap-2 hover:text-rose-500 transition-colors">Sponsor <HeartIcon size={10} className="text-rose-500" /></a></li>
                  <li><a href="https://github.com/Ankitkumar7217734/PaperKnife/issues" target="_blank" className="hover:text-rose-500 transition-colors">Report Bug</a></li>
            ...
            <div className="pt-6 border-t border-gray-100 dark:border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-[11px] text-gray-400 dark:text-zinc-600 font-medium">
              ...
              <div className="flex gap-6 items-center">
                 <a href="https://github.com/Ankitkumar7217734" target="_blank" className="hover:text-gray-900 dark:hover:text-white transition-colors">@Ankitkumar7217734</a>
              </div>
            </div>
          </div>
        </footer>
