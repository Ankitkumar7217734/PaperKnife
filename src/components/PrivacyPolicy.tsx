    ...
    <div className="min-h-screen pk-shell selection:bg-rose-500 selection:text-white p-6 md:p-12 pb-24">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="p-10 bg-emerald-500 text-white rounded-[3rem] flex flex-col md:flex-row items-center gap-10 relative overflow-hidden shadow-2xl shadow-emerald-500/20">
           ...
           <div className="flex-1 text-center md:text-left relative z-10">
              ...
              <div className="flex flex-wrap justify-center md:justify-start gap-4">
                 <a href="https://github.com/Ankitkumar7217734/PaperKnife" target="_blank" className="px-8 py-3 bg-white text-emerald-600 rounded-xl font-black uppercase text-[10px] tracking-widest hover:scale-105 transition-transform flex items-center gap-2 shadow-lg">
        ...
        <div className="pt-12 text-center opacity-30">
           ...
           <p className="text-[10px] font-black uppercase tracking-[0.5em] text-gray-400">Privacy Protocol v1.4.0 Stable</p>
        </div>
      </div>
    </div>
  )
    ...
    <NativeToolLayout title="Privacy" description="Data Security Spec" actions={null}>
      <div className="px-4 pb-32 animate-in fade-in slide-in-from-bottom-4 duration-700 space-y-4">
        ...
        <div className="bg-zinc-900 text-white rounded-[2rem] p-8 relative overflow-hidden">
           ...
           <a 
             href="https://github.com/Ankitkumar7217734/PaperKnife" 
             target="_blank" 
